export default {
  ...
  q3: {
    q: "Why is child marriage bad?",
    r: "Child brides are more likely to become pregnant before their bodies are mature, increasing the risks of both mother and child death and health issues. When an adolescent girl give birth in developing countries, where access to sexual and reproductive health services is generally low, complications from pregnancy and childbirth can be deadly. In fact, globally, these complications are the leading cause of death among adolescent girls.",
  },
  q4: {
    q: "Are child brides more vulnerable to sexual transmitted diseases?",
    r: "Children who are married off are also vulnerable to sexually transmitted infections, including HIV. Contributing to this problem is the fact that girls who have dropped out of school are more vulnerable to child marriage and less likely to be equipped with information about protecting themselves from sexual diseases and unplanned pregnancy.",
  },
  q5: {
    q: "What are the consequences on brides’ children?",
    r: "Lack of education and empowerment also mean girls are less able to advocate for the well-being of their own children. The children of child brides have higher mortality rates, worse nutritional outcomes and tend to be less educated.",
  },
  q6: {
    q: "What are other consequences of child marriage?",
    r:
  ...
  q7: {
    ...
    r: "It is your right to decide when and who to marry. You should try to say clearly that you don’t want to marry in this moment, if it is not what you desire, and tell them that it is illegal to get married under 18. \nYou can look for support from organisations that can help you and keep you safe from those who are forcing you or ask to some adult you trust to help you to speak with those who are pressuring you. ",
  },
  q8: {
